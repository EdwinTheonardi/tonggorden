...
$sql = "INSERT INTO produk 
		(kode, kategori, idwarna, idmotif, foto) 
		VALUES 
		('$kode', '$kategori', '$warna', '$motif', '$foto')";
...
<html lang="en">
	...
	<!-- Produk Save Modal -->
	<div class="modal fade" id="produkSaveModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
